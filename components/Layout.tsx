...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange }) => {
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      {/* Fixed Header */}
      <header className="fixed top-0 left-0 right-0 z-[60] w-full bg-blue-600 text-white px-4 h-16 flex items-center shadow-md pt-[env(safe-area-inset-top)] h-[calc(4rem+env(safe-area-inset-top))]">
      ...
      {/* Bottom Navigation with Safe Area Fix */}
